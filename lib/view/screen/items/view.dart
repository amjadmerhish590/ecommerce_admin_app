...
class ItemsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<ItemsController>(builder: (controller) => HandlingDataView(statusRequest: controller.statusRequest, widget: WillPopScope(
        onWillPop: (){
                                  ...
                                  children: [
                                    IconButton(onPressed: (){
                                      Get.defaultDialog(title: "Warning", middleText: "Are you sure about the deletion process?", onCancel: (){}, onConfirm: (){
                                        controller.deleteItem(controller.data[index].itemsId.toString(), controller.data[index].itemsImage!);
                                        Get.back();
                                      });
